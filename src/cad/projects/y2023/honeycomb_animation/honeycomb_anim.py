...
outline = Point(0, 0).buffer(200, quad_segs=8) - Point(0, 0).buffer(100, quad_segs=8)
rim = outline - outline.buffer(-5, quad_segs=8)
...
for i in range(2, 200, 2):
    ...
    project_steps.record(shape, key=f"shape_{i}")
