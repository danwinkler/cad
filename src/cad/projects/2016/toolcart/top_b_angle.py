...
parts.append(
    up(outer_y)(
        rotate(a=-53.13, v=[1, 0, 0])(
            translate([0, 0, 0])(cube([outer_x, outer_y - 10, 40]))
        )
    )
)
...
parts.append(
    hole()(
        translate([wall_thickness, wall_thickness, wall_thickness])(
            cube([inner_x, length, inner_y + wall_thickness]),
            cube([length, inner_x, inner_y + wall_thickness]),
        ),
        translate([wall_thickness, wall_thickness, outer_y])(
            rotate(a=-53.13, v=[1, 0, 0])(
                translate([0, 0, 0])(cube([inner_x, length - 10, inner_y]))
            )
        ),
    )
)
...
parts += [
    ...
    translate([0, outer_y * 0.625, outer_y * 1.2])(
        rotate(a=-90, v=[0, 1, 0])(screwhole("#8 Wood", wall_thickness + 1))
    ),
    translate([outer_x, outer_y * 0.625, outer_y * 1.2])(
        rotate(a=90, v=[0, 1, 0])(screwhole("#8 Wood", wall_thickness + 1))
    ),
